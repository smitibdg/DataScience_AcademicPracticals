...
select student_id, name, age from college.student where student_id=01;

-- inserting new data into the data table
insert into college.student(student_id,name,age) values(03, 'Priya', 22);
insert into college.student(student_id,name,age) values(04, 'Kripa', 27);
insert into college.student(student_id,name,age) values(05, 'Animesh', 29);
insert into college.student(student_id,name,age) values(07, 'Deepika', 24);
insert into college.student(student_id,name,age) values(08, 'Nikhil', 30);
-- using 
select * from college.student where Name like'_a%';

select * from college.stsudent where Name like '%x';

select * from college.stsudent where Name like '%esh';

select * from college.stsudent where Name like '_eepika%';
